...
class Alert extends Component {
    ...
    alertColor = (status) => {
        ...
        switch (status) {
            ...
            case 'warning':
                ...
                break;
            case 'warning-light':
                color = this.props.circleColor ? this.props.circleColor : '#ffd27f';
                break;
            case 'info':
                color = this.props.circleColor ? this.props.circleColor : '#34C4FC';
                break;
            case 'error-info':
                color = this.props.circleColor ? this.props.circleColor : '#666666';
                break;
            default:
                break;
        }
    ...
    renderIcon = (status) => {
        ...
        switch (status) {
            case 'success':
                icon = propIcon ? propIcon : require('./img/check.png');
                break;
            case 'error':
                icon = propIcon ? propIcon : require('./img/close-cross.png');
                break;
            case 'warning':
                icon = propIcon ? propIcon : require('./img/warning.png');
                break;
            case 'warning-light':
                icon = propIcon ? propIcon : require('./img/info.png');
                break;
            case 'info':
                icon = propIcon ? propIcon : require('./img/info.png');
                break;
